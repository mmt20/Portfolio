...
const getCurrentIcone = () =>
  document.body.classList.contains(iconTheme) ? 'ri-moon-line' : 'ri-sun-line';

// We validate if the user previosly chose a topic
if (selectedTheme) {
  // If the validation is fulfilld, we ask what the issue was to know if we activated or deactivated
...
themeButton.addEventListener('click', () => {
  ...
  localStorage.setItem('selected-icon', getCurrentIcone());
});
